...
public class CustomerLegalRegistration implements Command{
	private static final Logger log = LoggerFactory.getLogger(CustomerLegalRegistration.class.getName());
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			user = userService.createCustomerLegal(user, locale);			
