...
public class ChangingUserSettingByAdmin implements Command {
	private static final Logger log = LoggerFactory.getLogger(ChangingUserSettingByAdmin.class.getName());
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			userService.editUser(selectedUser, locale);
			...
			if (locale.equals(ControllerConstant.LOCALE_RU_PARAM_NAME)) {
				session.setAttribute(ParamAndAttribute.SUCCESS_EDIT_ATTRIBUTE, "Данные пользователя успешно изменены");
			} else {
