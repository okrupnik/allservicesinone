        ...
        <div class="container">
			...
			<div class="col-sm-2">
				<div class="form-group">
					...
					<select multiple="multiple" name="subspecialization">
						<c:forEach items="${SubSpecalizationList}" var="SubSpecalizationList">
							<option value="${SubSpecalizationList}" ${not empty sessionScope.specialization.subspecialization[SubSpecalizationList] ? 'selected' : ''}>${SubSpecalizationList}</option>
						</c:forEach>
					</select>
				</div>
			</div>
